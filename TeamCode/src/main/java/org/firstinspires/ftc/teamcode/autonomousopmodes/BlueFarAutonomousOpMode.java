...
public class BlueFarAutonomousOpMode extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            if (teamHardwareMap.runTime.milliseconds() < AutonomousSharedValues.MILLISECONDS_PER_HORIZONTAL_TILE * 1) { // one tile left
                mecanumHelper.autonomousMoveLeft();
                    ...
                    + AutonomousSharedValues.MILLISECONDS_PER_VERTICAL_TILE * 3) { // then, three tiles backward
